...
namespace BlockchainApplication
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                throw new Exception("Username needs to have a length of 2");
            }
            ...
            NodeOperation nodeOperation = new NodeOperation(seedNodes, listeningPort, username);
            nodeOperation.InitOperations();
